...
export async function GET(request: NextRequest) {
  try {
    ...
    console.log('🧾 Edge Storage API: Getting receipts...')
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log('🧾 Edge Storage API: Uploading receipt...')
    ...
    console.log('✅ Edge Storage API: Receipt uploaded successfully')
...
export async function DELETE(request: NextRequest) {
  try {
    ...
    console.log('🧾 Edge Storage API: Deleting receipt...')
    ...
    console.log('✅ Edge Storage API: Receipt deleted successfully')
