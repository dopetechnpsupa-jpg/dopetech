...
export async function GET(request: NextRequest) {
  try {
    ...
    console.log('🎠 Edge Storage API: Getting hero images...')
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log('🎠 Edge Storage API: Uploading hero image...')
    ...
    console.log('✅ Edge Storage API: Hero image uploaded successfully')
...
export async function DELETE(request: NextRequest) {
  try {
    ...
    console.log('🎠 Edge Storage API: Deleting hero image...')
    ...
    console.log('✅ Edge Storage API: Hero image deleted successfully')
