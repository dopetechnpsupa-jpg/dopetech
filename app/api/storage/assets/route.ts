...
export async function GET(request: NextRequest) {
  try {
    ...
    console.log('📁 Edge Storage API: Getting assets...')
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log('📁 Edge Storage API: Uploading asset...')
    ...
    console.log('✅ Edge Storage API: Asset uploaded successfully')
...
export async function DELETE(request: NextRequest) {
  try {
    ...
    console.log('📁 Edge Storage API: Deleting asset...')
    ...
    console.log('✅ Edge Storage API: Asset deleted successfully')
